...
```sh
./blue validate     # desired state, tools, and Vultr access
./blue build        # render .colors/ only — contacts nothing
./blue create --dry-run
./blue create
./blue delete       # guarded; stops the cluster, destroys DNS and compute
```
