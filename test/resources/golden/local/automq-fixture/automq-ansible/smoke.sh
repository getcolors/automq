...
for role in data ops; do
  bucket=$([ "$role" = data ] && echo "automq-fixture-data" || echo "automq-fixture-ops")
  n=$(python3 - "$bucket" <<'PY'
import os, sys, boto3
from botocore.config import Config
s3 = boto3.client("s3", endpoint_url="https://fixture.r2.cloudflarestorage.com", region_name="auto",
