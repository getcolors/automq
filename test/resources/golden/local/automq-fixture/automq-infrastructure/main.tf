...
resource "vultr_ssh_key" "machine" {
  ...
  ssh_key = fileexists("/home/build-placeholder/.ssh/automq-fixture.pub") ? trimspace(file("/home/build-placeholder/.ssh/automq-fixture.pub")) : "ssh-ed25519 PLACEHOLDER managed-by-colors"
}
