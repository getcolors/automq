...
for role in data ops; do
  bucket=$([ "$role" = data ] && echo "automq-gcs-fixture-data-colors-example-us-central1" || echo "automq-gcs-fixture-ops-colors-example-us-central1")
  n=$(python3 - "$bucket" <<'PY'
import os, sys, boto3
from botocore.config import Config
s3 = boto3.client("s3", endpoint_url="https://storage.googleapis.com", region_name="us-central1",
