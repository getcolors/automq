...
for role in data ops; do
  bucket=$([ "$role" = data ] && echo "automq-aws-data-123456789012-us-east-1" || echo "automq-aws-ops-123456789012-us-east-1")
  n=$(python3 - "$bucket" <<'PY'
import os, sys, boto3
from botocore.config import Config
s3 = boto3.client("s3", endpoint_url="https://s3.us-east-1.amazonaws.com", region_name="us-east-1",
